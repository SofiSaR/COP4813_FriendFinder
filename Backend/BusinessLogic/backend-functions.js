...
export async function getId() {
    const response = await fetch('/COP4813_FriendFinder/Backend/Database/get-user-id.php', { credentials: 'same-origin' });
...
export async function fetchQuestions() {
    const questions = await fetch('/COP4813_FriendFinder/Backend/Database/get-questions.php');
...
export async function submitQuizResponses(answers) {
    const response = await fetch('/COP4813_FriendFinder/Backend/Database/submit-quiz-responses.php', {
        method: 'POST',
...
export async function fetchScores(userId) {
    const scoresFetched = await fetch(`/COP4813_FriendFinder/Backend/Database/get-scores.php`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
export async function fetchMatches(limit) {
    const matches = await fetch(`/COP4813_FriendFinder/Backend/Database/get-matches.php`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
export async function fetchUserProfile(userId) {
    const user = await fetch(`/COP4813_FriendFinder/Backend/Database/get-user-profile.php`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ user_id: userId })
    });
